...
# метод mean массива Numpy. Результат запишите в массив mean_a,
# в нем должно быть 2 элемента.

import numpy as np

# ленивый человек не пишет python массивы, где строк больше, чем столбцов :)
...
# двух признаков, содержащихся в массиве “а”.
...
# В получившейся ковариационной матрице (массив Numpy размером 2x2) искомое
# значение ковариации будет равно элементу в строке с индексом 0 и столбце с индексом 1.

a_centered_check = np.cov(a.T)[0][1]
print(f'{a_centered_check = }')
